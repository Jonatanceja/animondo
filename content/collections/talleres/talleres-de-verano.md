---
id: dd00debb-9588-4144-aa71-14f8effb67f5
blueprint: taller
title: 'Talleres de verano'
descripcion: '<p>Cinco días para aprender a animar cuadro por cuadro. Los <em>animautas</em> entran el lunes sin saber nada y el viernes se van con sus propias animaciones, su primera gorra y pin, y la certeza de que pueden crear sus propios mundos.</p><p>Cada semana tiene un tema diferente, así que pueden venir una, dos o el verano completo.</p><p>No son clases. Es un viaje creativo.</p><p>Para<em> animautas </em>de 6 a 16 años en grupos separados por edades.</p>'
...
mensaje_importante: 'PAQUETE ANIMONDO EXPRESS: ¡Pregunta por la opción con transporte y desayuno!'
edad: '6 - 16 años'
vespertino:
  dias:
    - lunes
...
resumen:
  -
    id: 81xHbhWD2WshtkB64wCjk
    type: opcion
    enabled: true
    titulo: 'Princesas y dragones'
    descripcion: 'La semana donde los castillos cobran vida y las leyendas se animan.'
    enlace: 'https://www.paypal.com/ncp/payment/6S732WDFUPS3G'
    fecha_de_inicio: '2026-07-06 06:00'
    fecha_de_finalizacion: '2026-07-10 06:00'
  -
    id: 0FgmEacmFmjfDXIn8dlqD
    titulo: Fútbol
    descripcion: 'El Mundial llegó a Animondo. El deporte como nunca lo habías visto: cuadro por cuadro.'
    type: opcion
    enabled: true
    fecha_de_inicio: '2026-07-13 06:00'
    fecha_de_finalizacion: '2026-07-17 06:00'
    enlace: 'https://www.paypal.com/ncp/payment/NP2FAUNQMPUDS'
  -
    id: Qv8yksBCUNcueym9lJq1J
    titulo: Zombies
    descripcion: 'Animación con sentido del humor, sesos y un poquito de horror.'
    type: opcion
    enabled: true
  ...
  -
    ...
    enabled: true
    titulo: Dinosaurios
    descripcion: 'Cinco días para hacer que el pasado vuelva a caminar.'
  ...
  -
    ...
    titulo: Selva
    descripcion: 'Tus animales favoritos en su versión animada.'
    type: opcion
    enabled: true
  ...
  -
    id: 9tOVvXFHBT1dOvtHgvCU2
    titulo: Superhéroes
    descripcion: 'Crea a tu personaje, anima sus poderes y salva al mundo.'
    type: opcion
    enabled: true
    fecha_de_inicio: '2026-08-17 06:00'
    fecha_de_finalizacion: '2026-08-21 06:00'
    enlace: 'https://www.paypal.com/ncp/payment/HRQSS48SUVRQW'
  -
    id: bU3MU_mboi2-W2Fal9TtO
    titulo: 'Mundo marino'
    descripcion: 'Sumérgete en una semana de criaturas, corrientes y secretos submarinos.'
    type: opcion
    enabled: true
